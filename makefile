...
# Created by RehabMan 
#
# Modified by Voight-Kampff -- Thanks to the gods of hackintosh, in no particular order: RehabMan, Piker-Alpha

DSLDIR=./SSDT/GA-H170N-WIFI
BUILDDIR=./build
HDA=ALC269
...
VERSION_ERA=$(shell ./bin/print_version.sh)
